...
# SeBa DWD simulation
We used a modified version of SeBa. We did not change any of the physics and only modified the output writing of the package. We can provide the steps to exactly modify the file upon request, but do not provide the modified package. SeBa files will stored within the folder 03_SeBa/package_SeBa
